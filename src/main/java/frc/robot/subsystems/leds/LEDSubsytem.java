...
public class LEDSubsytem extends SubsystemBase {
  ...
  public Command runStrobeAnimation(RGBWColor color) {
    StrobeAnimation strobeAnimation =
        new StrobeAnimation(0, LEDConstants.LedCount - 1).withColor(color);
  ...
  public Command runColorFlowAnimation(RGBWColor color) {
    ColorFlowAnimation colorFlowAnimation =
        new ColorFlowAnimation(0, LEDConstants.LedCount - 1).withColor(color);
  ...
  public Command runLarsonAnimation(RGBWColor color) {
    LarsonAnimation larsonAnimation =
        new LarsonAnimation(0, LEDConstants.LedCount - 1).withColor(color);
  ...
  public Command runSingleFadeAnimation(RGBWColor color) {
    SingleFadeAnimation singleFadeAnimation =
        new SingleFadeAnimation(0, LEDConstants.LedCount - 1).withColor(color);
  ...
  public Command runTwinkleAnimation(RGBWColor color) {
    TwinkleAnimation twinkleAnimation =
        new TwinkleAnimation(0, LEDConstants.LedCount - 1).withColor(color);
