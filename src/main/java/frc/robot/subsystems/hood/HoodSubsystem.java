...
public class HoodSubsystem extends SubsystemBase {
  ...
  private static final LoggedTunableNumber kP = new LoggedTunableNumber("Hood/kP", 30000.0);
  private static final LoggedTunableNumber kD = new LoggedTunableNumber("Hood/kD", 300.0);
  ...
  public void periodic() {
    ...
    double targetRad = MathUtil.clamp(goalAngleRad, minRad, maxRad) - offsetRad;
  ...
  public void zero() {
    offsetRad = Units.degreesToRadians(minAngleDeg.get()) - inputs.positionRad;
    zeroed = true;
  }
