...
public class TargetingConstants {
  ...
  public static Pose2d redLeftFerryingTarget =
      new Pose2d(
          TargetingConstants.fieldLengthMeters - blueLeftFerryingTarget.getX(),
          blueLeftFerryingTarget.getY(),
          Rotation2d.kZero);
  public static Pose2d redRightFerryingTarget =
      new Pose2d(
          TargetingConstants.fieldLengthMeters - blueRightFerryingTarget.getX(),
          blueRightFerryingTarget.getY(),
          Rotation2d.kZero);
